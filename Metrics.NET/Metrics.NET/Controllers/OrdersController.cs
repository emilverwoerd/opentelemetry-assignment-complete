...
public class OrdersController : ControllerBase
{
    ...
    private readonly IComputerComponentsMetrics _computerComponentsMetrics;

    public OrdersController(IComputerComponentsMetrics computerComponentsMetrics)
    {
        _computerComponentsMetrics = computerComponentsMetrics;
    }
    ...
    public IActionResult CreateComputerComponent(string name, double price)
    {
        ...
        _computerComponentsMetrics.AddComputerComponent();
    ...
    public IActionResult Checkout(int orderId)
    {
        ...
        _computerComponentsMetrics.AddOrderComplete(orderId);
        _computerComponentsMetrics.RecordOrderTotalComponents(order.Items?.Count ?? 0);
